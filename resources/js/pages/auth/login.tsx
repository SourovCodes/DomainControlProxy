                ...
                <Card className="w-full max-w-md overflow-hidden border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800">
                    <CardContent className="p-8">
                        ...
                        <div className="space-y-4">
                            <a href="/auth/google">
                                <Button
                                    className="w-full bg-white text-slate-700 shadow-md transition-all hover:bg-slate-50 hover:shadow-lg dark:bg-slate-700 dark:text-white dark:hover:bg-slate-600"
                                    size="lg"
                                >
